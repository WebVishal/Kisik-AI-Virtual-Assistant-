...
const aCx ="underline decoration-primary-400/0 hover:decoration-primary-400 underline-offset-4 transition-all duration-300";
    ...
    >
      <div className="group flex gap-8">
        ...
        <nav className="pointer-events-none flex-row items-center gap-8 text-lg leading-7 hidden group-hover:flex group-hover:pointer-events-auto">
          <a href="https://webvishal.in" target="_blank" className={aCx}>
            Portfolio
          </a>
          <a
            href="https://github.com/WebVishal/Kisik-AI-Virtual-Assistant-"
            target="_blank"
            className={aCx}
          >
            Source code
